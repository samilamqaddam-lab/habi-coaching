...
async function getCoachingStats(): Promise<CoachingStats> {
  if (!isSupabaseConfigured() || !supabaseAdmin) {
    return { total: 0, pending: 0, contacted: 0, confirmed: 0, cancelled: 0, thisWeek: 0 };
  }
  ...
  try {
    ...
    console.error('Error in getCoachingStats:', error);
    return { total: 0, pending: 0, contacted: 0, confirmed: 0, cancelled: 0, thisWeek: 0 };
  }
}
        ...
        <div className="p-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-400">
              Gérez les demandes de coaching professionnel
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-8">
            ...
            <div className="bg-slate-800 rounded-xl border border-slate-700 p-5">
              <div className="flex items-center justify-between mb-2">
                <span className="text-slate-400 text-sm font-medium">Contactés</span>
                <svg className="w-5 h-5 text-blue-400" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                </svg>
              </div>
              <p className="text-2xl font-bold text-slate-100">{stats.contacted}</p>
            </div>
