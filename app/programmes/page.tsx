...
export default function ProgrammesPage() {
  ...
  const programmeImages: Record<number, string> = {
    1: '/images/Reel/IMG_4078.jpeg', // Vraie photo du lieu de retraite
    2: '/images/programmes/leadership-workshop.jpg',
    3: '/images/programmes/balance-yoga.jpg',
    4: '/images/programmes/philosophy-training.jpg',
    5: '/images/programmes/silence-retreat.jpg',
  };
              ...
              <div className="grid lg:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-1">
                  <div className="aspect-[4/3] relative rounded-xl overflow-hidden group-hover:shadow-lg transition-all">
                    <Image
                      src={programmeImages[programme.id] || '/images/programmes/atlas-mountains.jpg'}
                      alt={programme.title}
                      fill
