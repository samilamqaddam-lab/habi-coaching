    ...
    <>
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-10">
          <a
            href="/organisations"
            className="group flex items-center gap-2 px-5 py-2.5 bg-morocco-blue/10 hover:bg-morocco-blue/20 rounded-full transition-all duration-300"
          >
            ...
            <span className="text-sm font-medium text-morocco-blue group-hover:text-morocco-blue/80">
              Organisations
            </span>
          </a>
          <a
            href="/coaching"
            className="group flex items-center gap-2 px-5 py-2.5 bg-mystic-mauve/10 hover:bg-mystic-mauve/20 rounded-full transition-all duration-300"
          >
            <svg className="w-5 h-5 text-mystic-mauve" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
            </svg>
            <span className="text-sm font-medium text-mystic-mauve group-hover:text-mystic-mauve/80">
              Coaching Individuel
            </span>
          </a>
          <a
            href="/programmes"
            className="group flex items-center gap-2 px-5 py-2.5 bg-golden-orange/10 hover:bg-golden-orange/20 rounded-full transition-all duration-300"
          >
            <svg className="w-5 h-5 text-golden-orange" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <span className="text-sm font-medium text-golden-orange group-hover:text-golden-orange/80">
              Yoga Traditionnel
            </span>
          </a>
        </div>
