              ...
              <div className="bg-white rounded-xl p-5 shadow-sm border border-morocco-blue/20">
                ...
                <div className="mt-4 pt-3 border-t border-morocco-blue/10">
                  <div className="flex items-start gap-1.5">
                    <svg className="w-3.5 h-3.5 text-morocco-blue mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <div className="text-xs text-text-secondary">
                      <p><strong className="text-deep-blue">6 000 DH HT</strong> — journée complète</p>
                      <p><strong className="text-deep-blue">4 000 DH HT</strong> — demi-journée</p>
                      <p className="text-[10px] mt-0.5">(soit 8 000 DH pour deux demi-journées)</p>
                    </div>
                  </div>
                </div>
              </div>
